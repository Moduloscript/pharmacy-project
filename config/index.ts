				...
				prices: [
					{
						...
						interval: "month",
						amount: 45000, // ₦45,000 per month (~$29 USD equivalent)
						currency: "NGN",
						seatBased: true,
						trialPeriodDays: 7,
					},
					{
						...
						interval: "year",
						amount: 450000, // ₦450,000 per year (~$290 USD equivalent, 17% discount)
						currency: "NGN",
						seatBased: true,
						trialPeriodDays: 7,
					},
				...
				prices: [
					{
						...
						amount: 1200000, // ₦1,200,000 lifetime (~$799 USD equivalent)
						currency: "NGN",
					},
				],
			},
