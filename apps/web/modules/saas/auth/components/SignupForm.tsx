...
const formSchema = z.object({
	...
	name: z.string().min(1),
	customerType: z.enum(['RETAIL', 'WHOLESALE', 'PHARMACY', 'CLINIC']).default('RETAIL'),
	phone: z.string().regex(/^(\+234|0)[789]\d{9}$/, 'Please enter a valid Nigerian phone number').optional(),
});
