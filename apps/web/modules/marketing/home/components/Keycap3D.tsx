    ...
    >
      ...
      >
        ...
        <path 
          ...
          className="key-base-left fill-black dark:fill-neutral-700"
        />
        ...
        <path 
          ...
          className="key-base-right fill-black dark:fill-neutral-700"
        />
        ...
        <path 
          ...
          className="key-top-outline fill-black dark:fill-white"
        />
        
        {/* Letter */}
        <path 
          d={letterPath}
          className="key-letter fill-black dark:fill-white"
        />
      </svg>
    </motion.div>
  );
