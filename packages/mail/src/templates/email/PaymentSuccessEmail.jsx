...
export function PaymentSuccessEmail(props) {
    ...
    return (<EmailLayout title={`Payment Confirmation - #${props.order_number}`} preview={`We received your payment for order #${props.order_number}.`}>
      <Section>
        ...
        {props.method && (<Text style={{ fontSize: 14, margin: '6px 0 0' }}>
            <strong>Method:</strong> {props.method}
          </Text>)}
        {props.transaction_id && (<Text style={{ fontSize: 14, margin: '6px 0 0' }}>
