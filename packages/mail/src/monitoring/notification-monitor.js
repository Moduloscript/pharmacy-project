...
export class NotificationMonitor {
    ...
    getMetrics(dateRange) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                // Get total counts
                const totalStats = yield db.notification.aggregate({
                    where: whereClause,
                    _count: {
                        id: true
                    }
                ...
                // Get stats by status
                const statusStats = yield db.notification.groupBy({
                    by: ['status'],
                    where: whereClause,
                    _count: {
                        id: true
                ...
                const channelStats = yield db.notification.groupBy({
                    by: ['channel', 'status'],
                    where: whereClause,
                    _count: {
                        id: true
                ...
                // Get stats by type
                const typeStats = yield db.notification.groupBy({
                    by: ['type', 'status'],
                    where: whereClause,
                    _count: {
                        id: true
                ...
                // Get recent activity
                const recentActivity = yield db.notification.findMany({
                    where: whereClause,
                ...
                // Process stats
                const sentCount = ((_a = statusStats.find(s => s.status === 'SENT')) === null || _a === void 0 ? void 0 : _a._count.id) || 0;
                const failedCount = ((_b = statusStats.find(s => s.status === 'FAILED')) === null || _b === void 0 ? void 0 : _b._count.id) || 0;
    ...
    getProviderHealth() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const notifications = yield db.notification.findMany({
                    where: {
                ...
                Object.entries(channelData).forEach(([channel, data]) => {
                    ...
                    const lastSuccess = ((_a = channelNotifications
                        .filter(n => n.status === 'SENT')
                        .sort((a, b) => b.createdAt.getTime() - a.createdAt.getTime())[0]) === null || _a === void 0 ? void 0 : _a.createdAt) || null;
                    const lastFailure = ((_b = channelNotifications
                        .filter(n => n.status === 'FAILED')
                        .sort((a, b) => b.createdAt.getTime() - a.createdAt.getTime())[0]) === null || _b === void 0 ? void 0 : _b.createdAt) || null;
                    healthStatus.push({
    ...
    getAdminStats() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const [todayStats, yesterdayStats, weekStats, monthStats, totalStats] = yield Promise.all([
     ...
     */
    logNotificationAttempt(notificationId, provider, attempt, result) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
            ...
            try {
                ...
                Object.entries(metrics.byChannel).forEach(([channel, stats]) => {
                    if (stats.successRate < 80) {
                        alerts.push({
                            ...
                            severity: stats.successRate < 50 ? 'high' : 'medium'
                        });
                    }
                });
                // Check for stuck notifications (pending for too long)
                const stuckNotifications = yield db.notification.count({
                    where: {
                        status: 'PENDING',
                        createdAt: {
                ...
                if (stuckNotifications > 0) {
                    alerts.push({
                        ...
                        severity: stuckNotifications > 10 ? 'high' : 'medium'
                    });
                }
            }
            catch (error) {
        ...
        return __awaiter(this, arguments, void 0, function* (days = 7) {
            try {
                ...
                for (let i = days - 1; i >= 0; i--) {
                    ...
                    const dayStats = yield this.getMetrics({ from: date, to: nextDate });
                    trends.push({
    ...
    getCostAnalysis(dateRange) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const metrics = yield this.getMetrics(dateRange);
    ...
    generateReport() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const metrics = yield this.getMetrics();
                const providerHealth = yield this.getProviderHealth();
                const alerts = yield this.checkForAlerts();
                const costAnalysis = yield this.getCostAnalysis();
                const trends = yield this.getDeliveryTrends(7);
